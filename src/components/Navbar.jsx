...
const Navbar = (props) => {
  ...
  return (
    <nav className={`navbar navbar-expand-sm fixed-top ${navBackground ? 'navbar-dark bg-dark text-light' : 'navbar-light bg-transparent text-light'}`} style={{ transition: '1s ease',}}>
